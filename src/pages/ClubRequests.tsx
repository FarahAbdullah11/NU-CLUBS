...
import BookRoom from "../components/BookRoom.tsx";
  ...
  return (
    <div className="club-requests-page">
          ...
          <div className="request-type-cards">
            ...
            >
              ...
              <p className="card-description">
                Request funding, book rooms, or submit new event proposals to
                the SU
              </p>
            </div>
            ...
            <div className="request-type-card">
              ...
              <p className="card-description">
                See all scheduled club activities and avoid conflicts with other
                events
              </p>
            </div>
      ...
      <BookRoom
        ...
        onSubmit={(data) => console.log("ROOM REQUEST DATA:", data)}
      />
    </div>
  );
};
